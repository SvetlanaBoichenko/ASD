...
//---------------------------
    ...
    public void test_Add2() {
        OrderedList<Integer> odl1 = new OrderedList<Integer>(false);
        odl1.add(1);
        odl1.add(2);
        odl1.add(3);
        odl1.add(4);
        ...
        assertTrue(odl1.count()== 5);
        assertTrue(odl1.head.value == 5);
        assertTrue(odl1.head.next.value == 4);
        assertTrue(odl1.head.next.next.value == 3);
        assertTrue(odl1.tail.value == 1);
        assertTrue(odl1.tail.prev.value == 2);

        odl1.add(1);
        assertTrue(odl1.count()== 6);
        assertTrue(odl1.head.value == 5);
        assertTrue(odl1.tail.prev.value == 1);
        assertTrue(odl1.tail.value == 1);
        ...
        odl1.add(5);
        assertTrue(odl1.head.value == 5);
        assertTrue(odl1.head.next.value == 5);
        assertTrue(odl1.count()== 10);

        odl1.add(2);
        assertTrue(odl1.count()== 11);
        assertTrue(odl1.tail.prev.prev.prev.value == 2);
        assertTrue(odl1.tail.prev.prev.prev.prev.value == 2);
    }

    @Test
    public void test_find() {
        OrderedList<Integer> odl2 = new OrderedList<Integer>(false);
        odl2.add(1);
        odl2.add(2);
        odl2.add(2);
        odl2.add(3);
