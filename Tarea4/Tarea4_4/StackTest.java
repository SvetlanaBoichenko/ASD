...
public class StackTest {
    ...
    public void test_sbalans() {
        ...
        String tsts2 = "((())";
        assertTrue(st.sbalans(tsts2) ==false );
        String tsts3 = "())(";
        assertTrue(st.sbalans(tsts2) ==false );
        String tsts4 = "))((";
        assertTrue(st.sbalans(tsts4) ==false );
        String tsts5 = ")()()()";
        assertTrue(st.sbalans(tsts5) ==false );
        String tsts6 = "((()()()()))))";
        assertTrue(st.sbalans(tsts6) == false );
        String tsts7 = "(() ( ()() ) ())";
        assertTrue(st.sbalans(tsts7) ==true );
    }
    @Test
    public void test_sbalansd() {
        ...
        Stack<Integer> st8 = new Stack<>();
        String tsts8 = "((){}(())()[])";
        assertTrue(st8.sbalansd(tsts8) == true );

        Stack<Integer> st9 = new Stack<>();
        String tsts9 = "{}((){}([()])()[])";
